...
export class MaterialService {
  ...
  private clasesMock: Clase[] = [
    { id_clase: 'CA', familia: 'COLORANTE', sub_familia: 'ACIDO', descripcion_completa: 'CA - COLORANTE ÁCIDO' },
    { id_clase: 'CC', familia: 'COLORANTE', sub_familia: 'CATIONICO', descripcion_completa: 'CC - COLORANTE CATIÓNICO' },
    { id_clase: 'CD', familia: 'COLORANTE', sub_familia: 'DISPERSO', descripcion_completa: 'CD - COLORANTE DISPERSO' },
    { id_clase: 'CR', familia: 'COLORANTE', sub_familia: 'REACTIVO', descripcion_completa: 'CR - COLORANTE REACTIVO' },
    { id_clase: 'CO', familia: 'COLORANTE', sub_familia: 'OPTICO', descripcion_completa: 'CO - COLORANTE ÓPTICO' },
    { id_clase: 'CI', familia: 'COLORANTE', sub_familia: 'DIRECTO', descripcion_completa: 'CI - COLORANTE DIRECTO' },
  ];
  ...
  private getProveedoresMock(): Proveedor[] {
    return [
      ...
      },
      {
        ...
        email: 'mgarcia@textilesdelsur.pe',
        telefono: '054-321-9876',
        created_at: new Date('2024-01-01'),
        updated_at: new Date('2024-01-01'),
      },
      {
        id_proveedor: 3,
        empresa: 'BASF Peruana S.A.',
        ruc: '20100063485',
        contacto: 'Ing. Carlos López',
        direccion: 'Av. Oscar R. Benavides 5915, Callao',
        email: 'carlos.lopez@basf.com',
        telefono: '01-513-2525',
        created_at: new Date('2024-01-01'),
        updated_at: new Date('2024-01-01'),
      },
      {
        id_proveedor: 4,
        empresa: 'Clariant (Perú) S.A.',
        ruc: '20100128056',
        contacto: 'Dra. Ana Torres',
        direccion: 'Av. Nicolás Ayllón 2634, Ate',
        email: 'ana.torres@clariant.com',
        telefono: '01-618-7070',
        created_at: new Date('2024-01-01'),
        updated_at: new Date('2024-01-01'),
      },
      {
        id_proveedor: 5,
        empresa: 'Huntsman Corporation Perú',
        ruc: '20504743768',
        contacto: 'Roberto Silva',
        direccion: 'Av. República de Panamá 3545, San Isidro',
        email: 'roberto.silva@huntsman.com',
        telefono: '01-315-9090',
        created_at: new Date('2024-01-01'),
        updated_at: new Date('2024-01-01'),
      },
      {
        id_proveedor: 6,
        empresa: 'CHT Germany GmbH Perú',
        ruc: '20600847652',
        contacto: 'Ing. Patricia Mendoza',
        direccion: 'Av. Los Frutales 325, La Molina',
        email: 'patricia.mendoza@cht.com',
        telefono: '01-365-8920',
        created_at: new Date('2024-01-01'),
        updated_at: new Date('2024-01-01'),
      },
      {
        id_proveedor: 7,
        empresa: 'Archroma Perú S.A.C.',
        ruc: '20544872770',
        contacto: 'Luis Vargas',
        direccion: 'Calle Las Begonias 441, San Isidro',
        email: 'luis.vargas@archroma.com',
        telefono: '01-319-0800',
        created_at: new Date('2024-01-01'),
        updated_at: new Date('2024-01-01'),
      },
      {
        id_proveedor: 8,
        empresa: 'DyStar Perú S.A.C.',
        ruc: '20507935941',
        contacto: 'Diana Flores',
        direccion: 'Av. Javier Prado Este 6210, La Molina',
        email: 'diana.flores@dystar.com',
        telefono: '01-419-5200',
        created_at: new Date('2024-01-01'),
        updated_at: new Date('2024-01-01'),
      },
    ];
